...
// 导入图片
import gzhQRCode from '../../assets/gzh.png';
        ...
        <div className="flex-1 p-4 overflow-auto">
          ...
          <div className="mb-6">
            ...
            <div className="flex flex-col items-center mb-8">
              ...
              />
              <p className="text-base text-gray-700 dark:text-gray-300">微信公众号：豆子爱分享</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">GitHub：weixin008</p>
            </div>
          </div>
        </div>
