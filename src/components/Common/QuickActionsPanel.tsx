...
const QuickActionsPanel: React.FC = () => {
  ...
  const categories = [
    ...
    { id: 'storage', name: '存储磁盘', icon: '💽', tools: storageTools },
    ...
    <div className="content-container">
      ...
      <div className="mt-8 flex flex-col items-center p-6 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
        ...
        <div className="flex flex-col items-center">
          <img src={zsmQRCode} alt="赞赏码" className="w-56 h-56 mb-3" />
          <p className="text-base text-gray-600 dark:text-gray-400">感谢您的支持！</p>
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">豆子爱分享 (GitHub: weixin008)</p>
        </div>
      </div>
